          ...
          <>
            <section className="grid grid-cols-1 lg:grid-cols-3 gap-4">
              ...
              <div className="bg-campus-900/80 border border-campus-800 rounded-xl p-6">
                ...
                {["Engineering", "Library", "Cafeteria"].map((name) => (
                  <div
                    key={name}
        ...
        return (
          <section className="bg-campus-900/80 border border-campus-800 rounded-xl p-8">
            ...
            <div className="space-y-4">
              {[
                { phase: "Phase 1", title: "Energy Audit & Baseline", status: "completed", timeline: "Q1 2024" },
                { phase: "Phase 2", title: "Solar PV Installation (100 kWp)", status: "in-progress", timeline: "Q2 2024" },
                { phase: "Phase 3", title: "HVAC Optimization & BMS Integration", status: "upcoming", timeline: "Q3 2024" },
                { phase: "Phase 4", title: "Battery Storage (200 kWh)", status: "upcoming", timeline: "Q4 2024" },
                { phase: "Phase 5", title: "Smart Grid & Demand Response", status: "upcoming", timeline: "Q1 2025" },
                { phase: "Phase 6", title: "Net-Zero Certification", status: "upcoming", timeline: "Q2 2025" },
              ].map((item) => (
